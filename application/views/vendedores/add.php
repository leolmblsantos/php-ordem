                        ...
                        <form method="POST" name="form_add">
                            ...
                            <fieldset class="mt-4 border p-2">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-user" name="vendedor_nome_completo" placeholder="Nome completo vendedor" value="<?php echo set_value('vendedor_nome_completo'); ?>">
                                        <?php echo form_error('vendedor_nome_completo', '<small id="emailHelp" class="form-text text-danger">','</small>'); ?>
                                    </div>

                                    <div class="col-md-3 mb-3">
                                        <label>CPF</label>
                                        <input type="text" class="form-control form-control-user cpf" name="vendedor_cpf" placeholder="CPF" value="<?php echo set_value('vendedor_cpf'); ?>">
                                        <?php echo form_error('vendedor_cpf', '<small id="emailHelp" class="form-text text-danger">','</small>'); ?>
                                    </div>
                                    
                                    <div class="col-md-3 mb-3">
                                        <label>RG</label>
                                        <input type="text" class="form-control form-control-user rg" name="vendedor_rg" placeholder="RG" value="<?php echo set_value('vendedor_rg'); ?>">
                            ...
                            <fieldset class="mt-4 border p-2">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-1">
                                        <label>UF</label>
                                        <input type="text" class="form-control form-control-user uf" name="vendedor_estado" placeholder="UF"  value="<?php echo set_value('vendedor_estado'); ?>">
                            ...
                            <fieldset class="mt-4 border p-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <textarea class="form-control form-control" name="vendedor_obs" placeholder="Observação"><?php echo set_value('vendedor_obs'); ?></textarea>
