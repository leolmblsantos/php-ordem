                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" name="form_edit">
                            <p><strong><i class="fas fa-clock"></i>&nbsp; &nbsp;Útima alteração: &nbsp; </strong><?php echo formata_data_banco_com_hora($produto->produto_data_alteracao); ?></p>
...
<!--                                                pode ser usado das com estas duas maneiras
                            ...
                            <fieldset class="mt-4 border p-2">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-9 mb-3">
                                        ...
                                        <textarea class="form-control form-control-user" name="produto_obs" placeholder="Observação"><?php echo $produto->produto_obs; ?></textarea>
                                        <?php echo form_error('produto_obs', '<small id="emailHelp" class="form-text text-danger">','</small>'); ?>
