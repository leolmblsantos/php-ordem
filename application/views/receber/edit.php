                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" name="form_edit">
                            <p><strong><i class="fas fa-clock"></i>&nbsp; &nbsp;Útima alteração: &nbsp; </strong><?php echo formata_data_banco_com_hora($conta_receber->conta_receber_data_alteracao); ?></p>
                            <fieldset class="mt-4 border p-2">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <?php echo form_error('conta_receber_unidade', '<small id="emailHelp" class="form-text text-danger">','</small>'); ?>
                                    </div>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control form-control-user" name="conta_receber_obs" placeholder="Observação"><?php echo $conta_receber->conta_receber_obs; ?></textarea>
