                ...
                <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a title="Cadastrar conta a receber" href="<?php echo base_url('receber/add') ?>" class="btn btn-success btn-sm float-right" ><i class="fas fa-plus"></i>&nbsp;Nova</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php foreach ($contas_receber as $conta): ?>
                                                ...
                                                <td class="text-center pr-4">
                                                    <?php
                                                        ...
                                                        if($conta->conta_receber_status == 1 ){
                                                            ...
                                                            echo '<span class="badge badge-secondary btn-sm">À Paga</span>';
                                                        }else if(strtotime($conta->conta_receber_data_vencimento) == strtotime(date('Y-m-d'))) {
                                            ...
                                            <div class="modal fade" id="conta-<?php echo $conta->conta_receber_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                aria-hidden="true">
