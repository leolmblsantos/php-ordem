                ...
                <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a title="Cadastrar conta a pagar" href="<?php echo base_url('pagar/add') ?>" class="btn btn-success btn-sm float-right" ><i class="fas fa-plus"></i>&nbsp;Nova</a>
                        </div>
                        <div class="card-body">
                                                ...
                                                <td class="text-center pr-4">
                                                    <?php
                                                        ...
                                                        if($conta->conta_pagar_status == 1 ){
                                                            ...
                                                            echo '<span class="badge badge-warning btn-sm">Vençe hoje</span>';
                                                        }else{
