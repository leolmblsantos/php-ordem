                ...
                <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a title="Cadastrar nova ordem serviço" href="<?php echo base_url('os/add') ?>" class="btn btn-success btn-sm float-right" ><i class="fas fa-shopping-basket"></i>&nbsp;Nova</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php foreach ($ordem_servicos as $os): ?>
                                            <tr>
                                                ...
                                                <td class="text-center pr-4"><?php  echo ($os->ordem_servico_status == 1 ? '<span class="badge badge-info btn-sm">Paga</span>' : '<span class="badge badge-warning btn-sm">Aberto</span>')?></td>
                                                <td class="text-right">
