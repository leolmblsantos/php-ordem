                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" name="form_edit">
                            <p><strong><i class="fas fa-clock"></i>&nbsp; &nbsp;Útima alteração: &nbsp; </strong><?php echo formata_data_banco_com_hora($cliente->cliente_data_alteracao); ?></p>
                            <fieldset class="mt-4 border p-2">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="date" class="form-control form-control-date" name="cliente_data_nascimento"  value="<?php echo $cliente->cliente_data_nascimento; ?>">
                            ...
                            <fieldset class="mt-4 border p-2">
                                ...
                                <legend class="font-small"><i class="fas fa-map-marker-alt"></i>nbsp;Dados de endereço</legend>
                                <div class="form-group row mb-3">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-1">
                                        <label>UF</label>
                                        <input type="text" class="form-control form-control-user uf" name="cliente_estado" placeholder="UF"  value="<?php echo $cliente->cliente_estado; ?>">
                            ...
                            <fieldset class="mt-4 border p-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <textarea class="form-control form-control-user" name="cliente_obs" placeholder="Observação"><?php echo $cliente->cliente_numero_endereco; ?></textarea>
