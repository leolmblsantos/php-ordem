                        ...
                        <form class="user" method="POST" name="form_edit">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="sistema_razao_social" placeholder="Razção social" value="<?php echo $sistema->sistema_razao_social; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea type="text" class="form-control form-control-user" name="sistema_txt_ordem_servico" placeholder="Texto de ordem de serviço e venda"><?php echo $sistema->sistema_txt_ordem_servico; ?></textarea>
                                    <?php echo form_error('sistema_endereco', '<small id="emailHelp" class="form-text text-danger">','</small>'); ?>
                                </div>
