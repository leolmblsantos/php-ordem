                                    ...
                                    <tbody>
                                        <?php foreach ($formas_pagamentos as $forma): ?>
                                            <tr>
                                                ...
                                                <td class="text-center pr-4"><?php  echo ($forma->forma_pagamento_aceita_parc == 1 ? '<span class="badge badge-info btn-sm">Sim</span>' : '<span class="badge badge-danger btn-sm">Não</span>')?></td>
                                                <td class="text-center pr-4"><?php  echo ($forma->forma_pagamento_ativa == 1 ? '<span class="badge badge-info btn-sm">Sim</span>' : '<span class="badge badge-warning btn-sm">Não</span>')?></td>
                                                <td class="text-right">
                                            ...
                                            <div class="modal fade" id="forma-<?php echo $forma->forma_pagamento_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                aria-hidden="true">
