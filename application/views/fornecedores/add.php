                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" name="form_add">
                            ...
                            <p><strong><i class="fas fa-clock"></i>&nbsp; &nbsp;Útima alteração: &nbsp; </strong><?php echo formata_data_banco_com_hora($fornecedor->fornecedor_data_alteracao); ?></p>
                            <?php endif; ?>
                            <fieldset class="mt-4 border p-2">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-user sp_celphones" name="fornecedor_celular" placeholder="Telefone Celular" value="<?php echo set_value('fornecedor_celular'); ?>">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-user" name="fornecedor_contato" placeholder="Nome do contato" value="<?php echo set_value('fornecedor_contato'); ?>">
                            ...
                            <fieldset class="mt-4 border p-2">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php echo form_error('fornecedor_endereco', '<small id="emailHelp" class="form-text text-danger">','</small>'); ?>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <?php echo form_error('fornecedor_numero_endereco', '<small id="emailHelp" class="form-text text-danger">','</small>'); ?>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <?php echo form_error('fornecedor_complemento', '<small id="emailHelp" class="form-text text-danger">','</small>'); ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <?php echo form_error('fornecedor_bairro', '<small id="emailHelp" class="form-text text-danger">','</small>'); ?>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <?php echo form_error('fornecedor_cep', '<small id="emailHelp" class="form-text text-danger">','</small>'); ?>
                                    </div>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <?php echo form_error('fornecedor_cidade', '<small id="emailHelp" class="form-text text-danger">','</small>'); ?>
                                    </div>
                                
                                    <div class="col-md-1">
                                        <label>UF</label>
                                        <input type="text" class="form-control form-control-user uf" name="fornecedor_estado" placeholder="UF"  value="<?php echo set_value('fornecedor_estado'); ?>">
                                        <?php echo form_error('fornecedor_estado', '<small id="emailHelp" class="form-text text-danger">','</small>'); ?>
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="mt-4 border p-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <textarea class="form-control form-control-user" name="fornecedor_obs" placeholder="Observação"><?php echo set_value('fornecedor_obs'); ?></textarea>
                                        <?php echo form_error('fornecedor_obs', '<small id="emailHelp" class="form-text text-danger">','</small>'); ?>
