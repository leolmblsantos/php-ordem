                        ...
                        <form method="POST" name="form_edit">
                            ...
                            <fieldset class="mt-4 border p-2">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-user" name="fornecedor_contato" placeholder="Nome do contato" value="<?php echo $fornecedor->fornecedor_contato; ?>">
                            ...
                            <fieldset class="mt-4 border p-2">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-1">
                                        <label>UF</label>
                                        <input type="text" class="form-control form-control-user uf" name="fornecedor_estado" placeholder="UF"  value="<?php echo $fornecedor->fornecedor_estado; ?>">
                            ...
                            <fieldset class="mt-4 border p-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <textarea class="form-control form-control-user" name="fornecedor_obs" placeholder="Observação"><?php echo $fornecedor->fornecedor_obs; ?></textarea>
