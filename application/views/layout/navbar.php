                        ...
                        <?php if($this->ion_auth->is_admin()) :  ?>
                            ...
                            <?php if(isset($contador_notificacoes) && $contador_notificacoes > 0): ?>
                                ...
                                <li class="nav-item dropdown no-arrow mx-1">
                                    <a class="nav-link dropdown-toggle blink_me" href="#" id="alertsDropdown" role="button"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                               ...
                               <?php   $user = $this->ion_auth->user()->row();?>
                                ...
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-800"><?php echo $user->first_name; ?></span>
