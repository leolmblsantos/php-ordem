...
class Ordem_servicos extends CI_Controller{
    ...
    public function index() {     
        $data = array(
            ...
            'titulo' => 'Ordem serviços cadastradas', 
...
//        exit();
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('ordem_servico_marca_equipamento', 'Modelo', 'trim|required|min_length[2]|max_length[80]');
...
//            exit();
    ...
    //            exit();
                ...
                $html .= '<th colspan="3">';
                    ...
                    $html .= '<td style="border-top: solid #add 1px">'.'R$&nbsp;' . $valor_final_os->os_valor_total .' </td>';
