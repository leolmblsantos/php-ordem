...
//        exit();
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('vendedor_nome_completo', '', 'trim|required|min_length[4]|max_length[200]');
            ...
            $this->form_validation->set_rules('vendedor_email', '', 'trim|required|max_length[100]|is_unique[vendedores.vendedor_email]');
...
//                exit();
    ...
    public function edit($vendedor_id = NULL) {
        ...
        if(!$vendedor_id || !$this->core_model->get_by_id('vendedores', array('vendedor_id' => $vendedor_id))){
            ...
            $this->form_validation->set_rules('vendedor_email', '', 'trim|required|max_length[100]|callback_check_vendedor_email');
