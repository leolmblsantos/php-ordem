...
//        exit();
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('fornecedor_email', '', 'trim|required|max_length[100]|is_unique[fornecedores.fornecedor_email]');
    ...
    public function edit($fornecedor_id = NULL) {
        ...
        if(!$fornecedor_id || !$this->core_model->get_by_id('fornecedores', array('fornecedor_id' => $fornecedor_id))){
            ...
            $this->form_validation->set_rules('fornecedor_email', '', 'trim|required|max_length[100]|callback_check_fornecedor_email');
