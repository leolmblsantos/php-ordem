...
//        exit();
    ...
    public function add() {
        ...
        if ($cliente_tipo == 1) {
            ...
            $this->form_validation->set_rules('cliente_cnpj', '', 'trim|required|exact_length[18]|is_unique[clientes.cliente_cnpj]|callback_valida_cnpj');
        }
...
//                exit();
    ...
    public function edit($cliente_id = NUll) {
        ...
        if(!$cliente_id || !$this->core_model->get_by_id('clientes', array('cliente_id' => $cliente_id))){
            ...
            $this->form_validation->set_rules('cliente_email', '', 'trim|required|max_length[20]|callback_check_email');
