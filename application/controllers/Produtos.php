...
class Produtos extends CI_Controller{
    ...
    public function index() {     
         ...
         *  [produto_id] => 1
            ...
            [produto_ativo] => 1
            [produto_obs] => 
            [produto_data_alteracao] => 2021-07-02 15:38:25
            [categoria_id] => 1
            [produto_categoria] => Games 1 Aterado
            [marca_id] => 1
            [produto_marca] => Multilaser Pro
            [fornecedor_id] => 1
            [produto_fornecedor] => Leonardo Inc new
         */
...
//        exit();
    ...
    public function check_produto_descricao($produto_descricao) {
        ...
        if($this->core_model->get_by_id('produtos', array('produto_descricao' => $produto_descricao, 'produto_id !=' =>$produto_id))){
            ...
            $this->form_validation->set_messege('check_produto_descricao', 'Esse produto já existe');
            return FALSE;
        }else{
...
//        AQUI RETIRA OS PONTOS E VIRGULA DOS VALORES
...
//        echo 'preço custo: '.$produto_preco_custo;
//        echo '<hr>';
//        echo 'preço custo: '.$produto_preco_venda;
//        exit();
//        } else {
//            exit('verificar');
//        }
